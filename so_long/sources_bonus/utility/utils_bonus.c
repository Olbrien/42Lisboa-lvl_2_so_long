...
/*   Updated: 2022/05/11 05:49:13 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_mlx(t_list *list)
{
	...
	if (list->images.enemy_01 != NULL)
		mlx_destroy_image(list->mlx.mlx_ptr, list->images.enemy_01);
	if (list->images.enemy_02 != NULL)
		mlx_destroy_image(list->mlx.mlx_ptr, list->images.enemy_02);
	if (list->images.enemy_03 != NULL)
		mlx_destroy_image(list->mlx.mlx_ptr, list->images.enemy_03);
	if (list->images.enemy_04 != NULL)
		mlx_destroy_image(list->mlx.mlx_ptr, list->images.enemy_04);
