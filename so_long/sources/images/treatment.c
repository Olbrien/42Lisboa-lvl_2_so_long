...
/*   Updated: 2022/05/10 19:23:33 by tisantos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	open_player_images(t_list *list)
{
	...
	list->images.player_01 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLAYER_01, &width, &height);
	if (list->images.player_01 == NULL)
		exit_error("Could not load image player_01\n", list);
	list->images.player_02 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLAYER_02, &width, &height);
	if (list->images.player_02 == NULL)
		exit_error("Could not load image player_02\n", list);
	list->images.player_03 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLAYER_03, &width, &height);
...
void	open_plant_images(t_list *list)
{
	...
	list->images.plant_01 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLANT_01, &width, &height);
	if (list->images.plant_01 == NULL)
		exit_error("Could not load image plant_01\n", list);
	list->images.plant_02 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLANT_02, &width, &height);
	if (list->images.plant_02 == NULL)
		exit_error("Could not load image plant_02\n", list);
	list->images.plant_03 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLANT_03, &width, &height);
	if (list->images.plant_03 == NULL)
		exit_error("Could not load image plant_03\n", list);
	list->images.plant_04 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, PLANT_04, &width, &height);
...
void	open_enemy_images(t_list *list)
{
	...
	list->images.enemy_01 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, ENEMY_01, &width, &height);
	if (list->images.enemy_01 == NULL)
		exit_error("Could not load image enemy_01\n", list);
	list->images.enemy_02 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, ENEMY_02, &width, &height);
	if (list->images.enemy_02 == NULL)
		exit_error("Could not load image enemy_02\n", list);
	list->images.enemy_03 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, ENEMY_03, &width, &height);
	if (list->images.enemy_03 == NULL)
		exit_error("Could not load image enemy_03\n", list);
	list->images.enemy_04 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, ENEMY_04, &width, &height);
...
void	open_effect_images(t_list *list)
{
	...
	list->images.effect_w = mlx_xpm_file_to_image(list->mlx.mlx_ptr, EFFECT_W, &width, &height);
...
void	open_door_images(t_list *list)
{
	...
	list->images.door_01 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, DOOR_01, &width, &height);
	if (list->images.door_01 == NULL)
		exit_error("Could not load image door_01\n", list);
	list->images.door_02 = mlx_xpm_file_to_image(list->mlx.mlx_ptr, DOOR_02, &width, &height);
